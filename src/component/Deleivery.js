  ...
  return (
    <Box
      sx={{
        ...
        alignItems: 'center',
        minHeight: '100vh',
        backgroundImage: 'url("https://img.freepik.com/premium-photo/photo-portrait-young-moped-rider-driver-wearing-white-face-mask-isolated-pastel-pink-color-background_274222-38918.jpg?w=740")', // Background image for the whole page
